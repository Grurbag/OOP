...
public class SaveGame {
    ...
    public SaveGame(ChessShape[][] chessBoard, boolean isWhiteTurn) {
        this.chessBoard = chessBoard;
    ...
    public static void save(String saveName, SaveGame gc) throws IOException {
    ...
    public static SaveGame read(File file) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.enable(DeserializationFeature.READ_ENUMS_USING_TO_STRING);
        return objectMapper.readValue(file, SaveGame.class);
    }
