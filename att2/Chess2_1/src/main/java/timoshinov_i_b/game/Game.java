...
import timoshinov_i_b.save.GameContext;
                        ...
                        if (!savesDirectory.exists()) {
                            ...
                            if (names.size() > 0) {
                                ...
                                if (index != -1) {
                                    ...
                                    this.chessBoard.setChessBoard(gc.getChessBoard());
                                    whiteTurn = gc.getWhiteTurn();
                                    cp = new ConsoleCommandProvider();
                                    this.gameContinues = true;
        ...
        switch (firstCommand.toLowerCase()) {
            ...
            case "save" -> {
                try {
                    ...
                    gc.setChessBoard(chessBoard);
                    gc.setWhiteTurn(whiteTurn);
